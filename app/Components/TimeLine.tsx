  ...
  return (
    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical pt-12">
      <li>
        ...
        <div className="timeline-end mb-10">hello I am text </div>
        <hr />
      </li>
      <li>
        <hr />
      ...
      <li>
        ...
        <div className="timeline-end mb-10">
          ...
          iPhone is a line of smartphones produced by Apple Inc. that use Apple
          s own iOS mobile operating system. The first-generation iPhone was
